...
/var/cache/salt/consul.zip:
  file.managed:
    ...
    - source: https://releases.hashicorp.com/consul/1.4.2/consul_1.4.2_linux_arm64.zip
    {% endif %}
    - source_hash: https://releases.hashicorp.com/consul/1.4.2/consul_1.4.2_SHA256SUMS
  service.dead:
    - names:
      - consul
  module.run:
