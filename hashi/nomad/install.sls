...
/var/cache/salt/nomad.zip:
  file.managed:
    ...
    - source: https://releases.hashicorp.com/nomad/0.8.7/nomad_0.8.7_linux_arm64.zip
    {% endif %}
    - source_hash: https://releases.hashicorp.com/nomad/0.8.7/nomad_0.8.7_SHA256SUMS
  service.dead:
    - names:
      - nomad
  module.run:
